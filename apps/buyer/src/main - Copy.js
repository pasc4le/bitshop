...
function Main(args) {
  ...
  return (
        ...
        >
            ...
            <p><strong>Sell, Build, Earn</strong></p>
            <p className='mb-1'><strong>FROM</strong></p>
            <h5><strong>3.173724 BTC</strong></h5>
  ...
  return (
    ...
    <div className='container'>
            ...
            <div className='col-12 col-md-4 col-lg-3'>
                <div className='banner-product'>
                    ...
                    <div className='banner-content'>
                        <p className='mb-0'>CATCH BIG <strong>DEALS</strong> ON THE CAMERAS</p>
                        <a href='#'><strong>Shop now <span className='bg-round bg-theme ms-2'><i className="uil uil-angle-right"></i></span></strong></a>
                    </div>
                </div>
                ...
                <div className='banner-product'>
                    ...
                    <div className='banner-content'>
                        <p className='mb-0'>SHOP THE <strong>HOTTEST</strong> PRODUCTS</p>
                        <a href='#'><strong>Shop now <span className='bg-round bg-theme ms-2'><i className="uil uil-angle-right"></i></span></strong></a>
                    </div>
                </div>
                ...
                <div className='banner-product'>
                    ...
                    <div className='banner-content'>
                        <p className='mb-0'>TABLETS, SMARTPHONES <strong>AND MORE</strong></p>
                        <a href='#' className='mt-1 d-flex align-items-center'>UP<br/>TO<h6 className='d-inline-block ms-2'>70% </h6> <span className='bg-round bg-theme ms-2'><i className="uil uil-angle-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class='container-fluid' >            
                    ...
                    <div >
                        <Link to={Details} className='p-box'>
                            ...
                            <p><strong>Mobile world</strong></p>
                    ...
                    <div>
                        <a href='#' className='p-box'>
                            ...
                            <p><strong>Spice Hotpot</strong></p>
                            <div className='ratings'>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                    ...
                    <div>
                        <a href='#' className='p-box'>
                            ...
                            <p><strong>Novelty Telecom</strong></p>
                            <div className='ratings'>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                    ...
                    <div>
                        <a href='#' className='p-box'>
                            ...
                            <p><strong>A L B Telecom</strong></p>
                            <div className='ratings'>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
                                <span><i className="fa fa-star" aria-hidden="true"></i></span>
        ...
        <div className='feature-section mt-4'>
            <h4 className='d-inline-block me-3 mb-0'>SHOP AND <strong>SAVE BIG</strong> ON HOTTEST TABLETS</h4>
            <button className='btn btn-theme feature-btn'>Start Buying<br/><span className="btn-text"><sup>₿</sup>74<sup>99</sup></span></button>
        </div>
    ...
    <div className='mt-5 newsletter-wrap'>
        <div className='container'>
            <div className='row align-items-center'>
                <div className='col-12 col-md-3'>
                    <p className='mb-0'><i className="uil uil-envelope me-3"></i>Newsletter</p>
                </div>
                <div className='col-12 col-md-3'>
                ...
                <div className="input-group">
                    <input type="text" className="form-control" placeholder="Enter your email address" aria-label="" aria-describedby="basic-addon2"/>
        ...
        <div className='row mt-4'>
            <div className='col-12 col-md-3'>
                <div className='shop-bg shop-img1 mt-2'>
                    ...
                    <h2 className='mt-0'><strong><sup>₿</sup>250<sub>OFF</sub></strong></h2>
                </div>
            </div>
            <div className='col-12 col-md-9'>
                <OwlCarousel items={1}  
