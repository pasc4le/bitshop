...
var BLASTR_EP = "https://bitshop.fadibarbara.it:8787/event";
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fetch(BLASTR_EP, { method: "POST", body: JSON.stringify(w) }),
          ];
        case 1:
          r = _a.sent();
          ok = r.ok;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            nostr_tools_1.nip04.encrypt(privAlice, pubBob, text),
          ];
        case 1:
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            nostr_tools_1.nip04.decrypt(privBob, pubAlice, encryptedData),
          ];
        case 1:
...
function signEvent(privKey, event) {
  ...
  var verified =
    (0, nostr_tools_1.verifySignature)(signed) &&
    (0, nostr_tools_1.validateEvent)(signed);
  if (!verified) {
